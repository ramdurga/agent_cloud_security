...
# Use the fixed version that works with Pydantic v2
from src.agents.langchain_agent_pydantic import LangChainSecurityAgentFixed as LangChainSecurityAgent
