...
class RealTimeProcessor:
    ...
    def apply_confidence_adjustment(self, detection: AnomalyDetection) -> AnomalyDetection:
        ...
        if detection.threat_level == 'low' and detection.confidence_score < 0.4:
            return None
            ...
            if event:
                ...
                if detection:
                    ...
                    if detection and self.correlate_events(detection):
                        ...
                        print(f"\n🔴 ANOMALY DETECTED: {detection.description}")
