...
from src.models.data_models_simple import ThreatLevel, EventType, NetworkEvent, UserBehaviorEvent

# For LangChain features
try:
    from src.agents.langchain_agent_simple import SimpleLangChainAgent
